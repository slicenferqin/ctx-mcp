...
**外部记忆机制**：
- 长输出 → 保存到 `.agent_memory/observations/`
...
- [AI编程最佳实践](./docs/ai-programming-best-practices.md) - 理论基础
- [文件系统作为外部记忆](./docs/file-system-as-external-memory.md) - 实现对比
- [Python MCP使用指南](./packages/python-mcp/README.md)
- [Node.js MCP使用指南](./packages/node-mcp/README.md)
- [CLI工具使用指南](./packages/cli/README.md)
...
本项目受以下工作启发：
- [InfiAgent](https://github.com/polyuiislab/infiAgent) - 十步策略和嵌套注意力机制
- [Manus](https://manus.im/zh-cn/blog/Context-Engineering-for-AI-Agents-Lessons-from-Building-Manus) - 可恢复压缩理念
- [Cursor](https://cursor.com/cn/blog/dynamic-context-discovery) - 动态上下文发现

## 📮 联系

- GitHub Issues: [提交问题](https://github.com/slicenferqin/ctx-mcp/issues)
- 讨论: [GitHub Discussions](https://github.com/slicenferqin/ctx-mcp/discussions)
